...
Public Sub InsertTab(TheString As String, Optional TheToolTip As String = "", Optional Index As Long = 0)
Dim ss As String
...
Dim dStyle As Long
dStyle = WS_CHILD Or WS_VISIBLE 'Or WS_TABSTOP
...
TipHwnd = CreateWindowEx(WS_EX_TOPMOST, "tooltips_class32", vbNullString, 0, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, 0, 0, App.hInstance, ByVal 0)
'Private Const WS_EX_TOPMOST = &H8&
'Private Const CW_USEDEFAULT = &H80000000
...
TmpTipInfo.uFlags = TTF_IDISHWND
...
Public Function TabIndex(Optional Index) As Long
